...
class MessageService:
        ...
        try:
            ...
            if message.role_name:
                ...
                if role is None:
                    ...
                    return False
                message.role = role
                isCreated = self.message_repository.create(message)
    ...
    def update_message(self, message_id: int, new_message: MessageModel) -> bool:
        try:
            ...
            return self.message_repository.update(message_id, old_message)
        except Exception as e:
    ...
    def delete_message(self, message_id: int) -> bool:
        try:
            ...
            isDelete = self.message_repository.delete(message_id=message_id)
